...
<body>
    ...
    <div class="container">
        <div class="row my-2">
            <div class="col-md">
                <h3 class="text-center fw-bold text-uppercase">Student Data</h3>
                <hr>
            </div>
        </div>
        <div class="row my-2">
                        ...
                        <?php foreach ($siswa as $row) : ?>
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="ubah.php?nis=<?= $row['nis']; ?>" class="btn btn-warning btn-sm" style="font-weight: 600;"><i class="bi bi-pencil-square"></i>&nbsp;Modify</a> |

                                    <a href="hapus.php?nis=<?= $row['nis']; ?>" class="btn btn-danger btn-sm" style="font-weight: 600;" onclick="return confirm('Are you sure you want to delete the data of <?= $row['nama']; ?> ?');"><i class="bi bi-trash-fill"></i>&nbsp;Delete</a>
                                </td>
                            </tr>
                        <?php endforeach; ?>
                    </tbody>
        ...
        <div class="modal-dialog modal-dialog-scrollable modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title fw-bold text-uppercase" id="detail">Student Details</h5>
...
Certifications: ISO9001, ISO17025, ISO27001, CMMI dev v1.2 
    ...
    <footer class="bg-dark text-white text-center" style="padding: 5px;">
        <p>Created with <i class="bi bi-suit-heart-fill" style="color: red;"></i> by <u style="color: #fff;">OUSS2K</u></p>
    </footer>
    <!-- Close Footer -->
