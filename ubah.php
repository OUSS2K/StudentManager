...
<body>
    ...
    <div class="container">
        <div class="row my-2">
            <div class="col-md">
                <h3 class="fw-bold text-uppercase"><i class="bi bi-pencil-square"></i>&nbsp;Modify Student Data</h3>
            </div>
            <hr>
        </div>
        <div class="row my-2">
                ...
                <form action="" method="post" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="form-check">
                            <input class="form-check-input" type="radio" name="jekel" id="Laki - Laki" value="Male" <?php if ($siswa['jekel'] == 'Male') { ?> checked='' <?php } ?>>
                            <label class="form-check-label" for="Laki - Laki">Male</label>
                        </div>
                        <div class="form-check">
                            <input class="form-check-input" type="radio" name="jekel" id="Perempuan" value="Female" <?php if ($siswa['jekel'] == 'Female') { ?> checked='' <?php } ?>>
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select w-50" id="jurusan" name="jurusan">
                            ...
                            <option value="Computer Science" <?php if ($siswa['jurusan'] == 'Computer Science') { ?> selected='' <?php } ?>>Computer Science</option>
                            <option value="Embedded System" <?php if ($siswa['jurusan'] == 'Embedded System') { ?> selected='' <?php } ?>>Embedded System</option>
                            <option value="Multimedia" <?php if ($siswa['jurusan'] == 'Multimedia') { ?> selected='' <?php } ?>>Multimedia</option>
                            <option value="Data Science" <?php if ($siswa['jurusan'] == 'Data Science') { ?> selected='' <?php } ?>>Data Science</option>
                        </select>
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        <label for="gambar" class="form-label">Picture <i>(Saat ini)</i></label> <br>
